package store.esgseed.api.soccer.player.service;

import lombok.RequiredArgsConstructor;
import store.esgseed.api.soccer.player.domain.Player;
import store.esgseed.api.soccer.player.domain.PlayerDTO;
import store.esgseed.api.soccer.player.repository.PlayerRepository;
